...
def create_app(test_config=None):
    ...
    albums_data_path = "music/adapters/data/raw_albums_excerpt.csv"
    tracks_data_path = "music/adapters/data/raw_tracks_excerpt.csv"
    users_data_path = "music/adapters/data/"

    if test_config is not None:
        app.config.from_mapping(test_config)
        albums_data_path = "tests/data/raw_albums_test.csv"
        tracks_data_path = "tests/data/raw_tracks_test.csv"
        users_data_path = "tests/data"
    if app.config['REPOSITORY'] == 'memory':
        ...
        database_mode = False
        repository_populate.populate_users(users_data_path, repo.repo_instance, database_mode)
        repository_populate.populate(albums_data_path, tracks_data_path, repo.repo_instance, database_mode)
